...
namespace AsianOptions
{
	...
	public class AsianOptionsPricing
	{
	    ...
	    public static double Simulation(CancellationToken token, Random rand, double initial, double exercise, double up, double down, double interest, long periods, long sims)
		{
