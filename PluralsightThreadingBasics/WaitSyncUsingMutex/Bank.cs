...
namespace WaitSyncUsingMutex
{
    ...
    class SimulationParameters
    {
        ...
        public const int TRANSFER_THREAD_PERIOD = 200;      // Amount of time (in MS) each transfer thread sleeps between transfers.
        public const int SIMULATION_LENGTH = 5 * 1000;         // Duration (in MS) of entire simulation.
    }
